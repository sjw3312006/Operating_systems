//Jeongwoon Suh : 301313489 : CMPT 300 : Assignment 2 (from Assignment 1)
...
struct List_s{
    struct List_s *freehead; //points to a free head in the headllist
    struct Node_s *head;
    struct Node_s *tail;
...
//prints the list to check the test functions
